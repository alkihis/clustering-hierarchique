 ...
 */
function* zip<T>(...its: Iterable<T>[]) : IterableIterator<T[]> {
...
function manhattan(item1: Coords, item2: Coords) {
...
function maxDistanceInCluster(cluster1: Cluster, cluster2: Cluster, distance_fn = manhattan) {
  let distance = -1;
...
function clusteringHierarchique(items: Coords[], distance_fn = manhattan) {
